...
import 'package:chacha20_poly1305/src/poly1305.dart';
...
void main() {
  group('Poly1305 test', () {
    test('the RFC sample', () {
      ...
      expect(toHex(poly1305(k, m)), actual);
    });
    ...
    test("example from NACL", () {
      ...
      var res = poly1305(key, msg);
      expect(res, equals(mac));
    });
    ...
    test('key = strings of zeros', () {
      ...
      expect(poly1305(key, m), equals(actual));
    });
    ...
    test('random key, empty message', () {
      ...
      expect(toHex(poly1305(key, m)), actual);
    });
